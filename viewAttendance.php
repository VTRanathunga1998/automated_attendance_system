            ...
            <div class="right-side">
                <div class="rs-top">
                    ...
                    <div class="logout-btn">
                        <button type="button" class="btn-center" onclick="return confirm('Are you sure?');"><a href="adminAttendanceRecord.php"><i class="fa fa-sign-out" aria-hidden="true"></i>  End</a></button>
                    </div>
                </div>
