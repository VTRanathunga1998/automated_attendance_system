                    ...
                    <div class="rs-middle">
                        <div class="create-session-container">
                            ...
                            <div class="pwc-middle">
                                ...
                                <form action="updateAttendanceExecute.php" method="POST">
                                    ...
                                    <div id="faculty_div">
                                        ...
                                        <div class="frm-select" >             
                                            <select id="faculty" name = "chooseFac" class="form-control" required></select>
                                        </div>
                                    ...
                                    <div id="department_div">
                                        ...
                                        <div class="frm-select" >              
                                            <select id="department" name = "chooseDep" class="form-control" required></select>
                                        </div>
                                    ...
                                    <div id="subject_div">
                                        <label >Subject</label>
                                        <div class="frm-select" >             
                                            <select id="subject" name = "chooseSub" class="form-control" required></select>
                                        </div> 
                                    ...
                                    <div class="frm-select ">             
                                        ...
                                        <select name="timeStartAMPM" id="" class="form-select mb-2 time-slot" required>
                                        ...
                                        <select name="timeEndAMPM" id="" class="form-select mb-2 time-slot" required>
                                            <option value="AM">AM</option>
                                            <option value="PM">PM</option>
                                        </select>
                                    </div> 
                                    ...
                                    <button type="submit" name="updateAttendance">View</button>
