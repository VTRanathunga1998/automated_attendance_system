                                ...
                                <form action="viewAttendance.php" method="POST">
                                    ...
                                    <div id="faculty_div">
                                        ...
                                        <div class="frm-select" >             
                                            <select id="faculty" name = "chooseFac" class="form-control" required>
                                    ...
                                    <div id="department_div">
                                        ...
                                        <div class="frm-select" >              
                                            <select id="department" name = "chooseDep" class="form-control" required>
                                    ...
                                    <div id="subject_div">
                                        <label >Subject</label>
                                        <div class="frm-select" >             
                                            <select id="subject" name = "chooseSub" class="form-control" required>
